...
const router = Router();
import { getContact, createContact, getContactById, deleteContact, updateContact, getAllContact, uploadImage, getImage, createUserContact, updateUserContact, switchUser } from "../controllers/userdataController.js";
